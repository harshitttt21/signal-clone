...
function timeAgo(iso?: string | null) {
  ...
  if (mins < 1) return "now";"use client";
...
export default function ConversationList({
  ...
  return (
    <div className="w-full md:w-[360px] flex-shrink-0 md:border-r border-signal-border flex flex-col bg-signal-bg h-full">
      <div className="flex items-center justify-between px-4 py-3 border-b border-signal-border">
        <div className="flex items-center gap-2 relative">
          ...
          >
            ...
            <span className="font-semibold text-[15px] text-signal-text truncate max-w-[140px]">
              {user?.display_name}
            </span>
          </button>
          {menuOpen && (
